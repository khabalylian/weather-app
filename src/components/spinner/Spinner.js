...
const Spinner = () => {
    return (
        <div className="spinner" style={{display: 'flex', justifyContent: 'center', alignItems: 'center', height: '100%'}}>
            <svg strokeWidth={58} height="58" viewBox="0 0 58 58" xmlns="http://www.w3.org/2000/svg">
